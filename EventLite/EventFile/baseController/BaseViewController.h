...
static NSString *NAVBUTTON_print = @"nav_print";
static NSString *NAVBUTTON_print_h = @"nav_print";
typedef enum {
...
@property (nonatomic, copy  ) AlertViewBlock alertViewBlock;
